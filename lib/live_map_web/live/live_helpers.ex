defmodule LiveMapWeb.LiveHelpers do
  ...
  def chat_svg(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 p-1">
  ...
  def spin_svg(assigns) do
    ...
    <div id={@id} class={@class}>
      <svg id={"svg-#{@id}"} class="inline mr-2 w-8 h-8 text-gray-100 animate-spin dark:text-gray-400 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
